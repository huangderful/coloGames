...
public class Wave {
	...
	public void startWave(PApplet marker, Character c, Screen s) {
		...
		if(wave == 1) {
			...
			enemyList.add(new Minotaur(s.getMultiplier()[2] * 7, 30, s.getMultiplier()[0] * 150, 75, s.getMultiplier()[1] * 50, Screen.SCREEN_WIDTH - 50, Screen.SCREEN_HEIGHT/2 - 50, 50, 50));
